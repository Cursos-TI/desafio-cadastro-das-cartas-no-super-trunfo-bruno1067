...
int main() {
    ...
    printf("Digite o nome da cidade (ex: Rio, etc. Obs: Não use espaços entre as palavras!): \n");
   ...
   printf("Digite o nome da cidade (ex: Salvador. Obs: Não use espaços entre as palavras!): \n");
